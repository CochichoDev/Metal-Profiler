...
T32EXTERN int  T32_ExecuteCommand(const char *pCommand, char* pBuffer, uint32_t BufferSize); /* preliminary */
T32EXTERN int  T32_ExecuteFunction(const char *pExpression, char* pBuffer, uint32_t BufferSize, uint32_t *pResultType); /* preliminary */
T32EXTERN int  T32_ExecuteFunction_Double(const char *pExpression, char* pBuffer, uint32_t BufferSize, double *pResult); /* preliminary */
T32EXTERN int  T32_ExecuteFunction_UInt64(const char *pExpression, char* pBuffer, uint32_t BufferSize, uint64_t *pResult); /* preliminary */
...
extern struct Channel_s *gChannel;
