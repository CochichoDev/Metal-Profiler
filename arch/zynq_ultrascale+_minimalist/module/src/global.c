...
PROP proprieties_system[5] = {
    ...
    {.NAME="BUDGET", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={1000,50000}, .iSTEP=1000},
    {.NAME="PERIOD", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={10,200}, .iSTEP=20},
    {.NAME="REPLENISHMENT", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={100,2000}, .iSTEP=100}
};
