...
PROP proprieties_system[6] = {
    {.NAME="CACHECOLORING", .PTYPE=pBOOL, .FLAGS=MITIGATION, .iRANGE={0,1}},
    {.NAME="MEMBANDWIDTH", .PTYPE=pBOOL, .FLAGS=MITIGATION, .iRANGE={0,1}},
    {.NAME="BUDGET", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={100,10000000}, .iSTEP=100},
    {.NAME="PERIOD", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={20,10000000}, .iSTEP=5},
    {.NAME="REPLENISHMENT", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={50,100000}, .iSTEP=50},
    {.NAME="THRESHOLD", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={100,1000}, .iSTEP=100}
};
