...
PROP proprieties_system[5] = {
    ...
    {.NAME="BUDGET", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={100,2000}, .iSTEP=100},
    {.NAME="PERIOD", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={20,100}, .iSTEP=5},
    {.NAME="REPLENISHMENT", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={50,1000}, .iSTEP=50}
};
