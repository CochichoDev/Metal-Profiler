...
# Path of this script: /home/local/MetaVonics_1/Core0_system/_ide/scripts/systemdebugger_core0_system_1_standalone.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /home/local/MetaVonics_1/Core0_system/_ide/scripts/systemdebugger_core0_system_1_standalone.tcl
# 
...
set bp_1_43_fsbl_bp [bpadd -addr &XFsbl_Exit]
con -block -timeout 60
bpremove $bp_1_43_fsbl_bp
targets -set -nocase -filter {name =~ "*A53*#0"}
rst -processor
