...
PROP proprieties_system[5] = {
    ...
    {.NAME="BUDGET", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={500,100000}, .iSTEP=500},
    {.NAME="PERIOD", .PTYPE=pINT, .FLAGS=OPTIMIZABLE|NEEDED, .iRANGE={500,1000000}, .iSTEP=50},
    {.NAME="THRESHOLD", .PTYPE=pDOUBLE, .FLAGS=OPTIMIZABLE|NEEDED, .fRANGE={0.01f,1.0f}, .fSTEP=0.01f}
};
